...
public sealed class DeleteWorkspaceScheduleCommandHandler : ICommandHandler<DeleteWorkspaceScheduleCommand>
{
    private readonly IWorkspaceScheduleRepository _scheduleRepository;
    private readonly IWorkspaceRepository _workspaceRepository;
    private readonly ICompanyRepository _companyRepository;

    public DeleteWorkspaceScheduleCommandHandler(
    ...
    public async Task HandleAsync(
        DeleteWorkspaceScheduleCommand command,
        CancellationToken cancellationToken = default)
    {
        ...
        await _scheduleRepository.DeleteAsync(command.ScheduleId, cancellationToken);
    }
